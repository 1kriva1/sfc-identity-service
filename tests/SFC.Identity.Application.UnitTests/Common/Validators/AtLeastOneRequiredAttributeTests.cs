...
//        // Assert
//        Assert.Equal(string.Format(Localization.AtLeastOneRequiredUnknownProperty, field1), result?.ErrorMessage);
//    }
...
//        // Assert
//        Assert.Equal(string.Format(Localization.AtLeastOneRequiredUnknownProperty, field2), result?.ErrorMessage);
//    }
...
//        Assert.Equal(string.Format(Localization.AtLeastOneRequired, field1, field2), result?.ErrorMessage);
//    }
